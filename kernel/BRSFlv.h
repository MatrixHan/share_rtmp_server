...
#define BRS_FLV_TAG_HEADER_SIZE 11
#define BRS_FLV_PREVIOUS_TAG_SIZE 4
...
public:
    ...
    char* payload;
private:
    class BrsSharedPtrPayload
    {
    public:
        // shared message header.
        BrsSharedMessageHeader header;
    ...
    public:
        BrsSharedPtrPayload();
        virtual ~BrsSharedPtrPayload();
    };
    BrsSharedPtrPayload* ptr;
public:
    BrsSharedPtrMessage();
    virtual ~BrsSharedPtrMessage();
public:
    /**
     ...
     */
    virtual int create(BrsCommonMessage* msg);
    /**
     * create shared ptr message,
     ...
     */
    virtual int create(BrsMessageHeader* pheader, char* payload, int size);
    /**
...
public:
     ...
     * @remark, assert object is created.
     */
    virtual BrsSharedPtrMessage* copy();
};
...
{
private:
    BrsFileWriter* reader;
private:
    BRSStream* tag_stream;
    char tag_header[BRS_FLV_TAG_HEADER_SIZE];
public:
    BrsFlvEncoder();
    virtual ~BrsFlvEncoder();
public:
    /**
    ...
    */
    virtual int initialize(BrsFileWriter* fr);
public:
    /**
    * write flv header.
    * write following:
...
public:
    ...
    */
    virtual int initialize(BrsFileReader* fr);
public:
    /**
